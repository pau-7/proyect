...
if (data.group !=='') {
 ...
 if(data.group === 'Development & Engineering' && data.experience === 'Infrastructure Engineer' && data.level === 'Mid Level'){
    ...
    median.textContent='2,000'
    min.textContent='1,500'
    max.textContent='3,150'
    candidatesSalary.textContent='1,600'
    teilursFee.textContent='400'
    bar.style.width='50%'
    }else if(data.group === 'Development & Engineering' && data.experience === 'Cybersecurity' && data.level === 'Senior Level') {
    price.textContent='3,150'
    total.textContent='3,150'
    median.textContent='3,150'
    min.textContent='2,000'
    max.textContent='3,750'
    candidatesSalary.textContent='2,520'
    teilursFee.textContent='630'
    bar.style.width='50%' 
